...
export const accentColor = "#7459D9";
export const accentColorDark = "#8884d8";
const tooltipStyles = {
  ...defaultStyles,
};
...
export default withTooltip<AreaProps, TooltipData>(
  ({
    ...
    const stock = appleStock.slice(contextValue?.value);
    console.log(stock);
      ...
      <div>
        ...
        {tooltipData && (
          ...
          >
            ...
            >
              NAV{" "}
              <span style={{ fontWeight: "bold" }}>{`${getStockValue(
                tooltipData
              )}`}</span>
            </TooltipWithBounds>
            <Tooltip
